...
void GlobalShortcutManager::KeyTrigger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        KeyTrigger *_t = static_cast<KeyTrigger *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData GlobalShortcutManager::KeyTrigger::staticMetaObjectExtraData = {
...
const QMetaObject GlobalShortcutManager::KeyTrigger::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GlobalShortcutManager__KeyTrigger,
      qt_meta_data_GlobalShortcutManager__KeyTrigger, &staticMetaObjectExtraData }
};
